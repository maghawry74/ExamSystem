...
namespace ExamSystem
{
    public partial class ExamDetails : Form
    {
        ...
        List<Course> UserCrs;
        public ExamDetails(List<Course> courses)
        {
            InitializeComponent();
            this.UserCrs = courses;
            CB_Course.DataSource = Db.Courses.Where(Crs=>UserCrs.Contains(Crs)).Include(crs => crs.Questions).ToList();
